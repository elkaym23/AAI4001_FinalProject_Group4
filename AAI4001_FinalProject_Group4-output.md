...
- **Generated On**: 2025-12-05 23:18:42 (Etc/GMT+5 / GMT-05:00)
...
├── 📁 fastapi_backend/
│   ├── 📁 __pycache__/
│   │   ├── 📄 AAI4001_FinalProject_Group4_fastapi.cpython-312.pyc (2.08 KB)
│   │   └── 📄 main.cpython-312.pyc (2.05 KB)
│   ├── 📄 AAI4001_FinalProject_Group4_fastapi.py (1.42 KB)
│   ├── 📄 model.pkl (343.3 MB)
│   ├── 📄 preprocessing.pkl (3.87 KB)
│   └── 📄 requirements.txt (64 B)
├── 📁 streamlit_frontend/
│   ├── 📄 AAI4001_FinalProject_Group4_deployment.py (17.77 KB)
...
- [📄 fastapi_backend/AAI4001_FinalProject_Group4_fastapi.py](#📄-fastapi-backend-aai4001-finalproject-group4-fastapi-py)
- [📄 fastapi_backend/requirements.txt](#📄-fastapi-backend-requirements-txt)
- [📄 streamlit_frontend/AAI4001_FinalProject_Group4_deployment.py](#📄-streamlit-frontend-aai4001-finalproject-group4-deployment-py)
...
- `fastapi_backend/__pycache__/AAI4001_FinalProject_Group4_fastapi.cpython-312.pyc`
- `fastapi_backend/__pycache__/main.cpython-312.pyc`

### <a id="📄-fastapi-backend-aai4001-finalproject-group4-fastapi-py"></a>📄 `fastapi_backend/AAI4001_FinalProject_Group4_fastapi.py`

**File Info:**
- **Size**: 1.42 KB
- **Extension**: `.py`
- **Language**: `python`
- **Location**: `fastapi_backend/AAI4001_FinalProject_Group4_fastapi.py`
- **Relative Path**: `fastapi_backend`
- **Created**: 2025-12-05 22:27:11 (Etc/GMT+5 / GMT-05:00)
- **Modified**: 2025-12-05 22:28:24 (Etc/GMT+5 / GMT-05:00)
- **MD5**: `9bcdf4aaac3109c8a652116f79cb7f0b`
- **SHA256**: `7fe0628772a3c0519c960d0b978c2a94545cfbe39616819d71d608615cf40c6f`
- **Encoding**: ASCII
...
### <a id="📄-streamlit-frontend-aai4001-finalproject-group4-deployment-py"></a>📄 `streamlit_frontend/AAI4001_FinalProject_Group4_deployment.py`

**File Info:**
- **Size**: 17.77 KB
- **Extension**: `.py`
- **Language**: `python`
- **Location**: `streamlit_frontend/AAI4001_FinalProject_Group4_deployment.py`
- **Relative Path**: `streamlit_frontend`
- **Created**: 2025-12-04 17:07:23 (Etc/GMT+5 / GMT-05:00)
- **Modified**: 2025-12-05 23:18:42 (Etc/GMT+5 / GMT-05:00)
- **MD5**: `79b99a5cef63f9de4d397f3759d9048a`
- **SHA256**: `95a88b750caa8ad98e57dddf19c0966ca03a663d6799a60917aaaf30d5380e60`
- **Encoding**: UTF-8
...
- **Modified**: 2025-12-05 22:31:36 (Etc/GMT+5 / GMT-05:00)
- **MD5**: `840ad6f0840e955790159992c0c81db1`
- **SHA256**: `e1aa954f0d18381a783b285eed4062da5073fa2469b464c4e6b78c14d030fc53`
- **Encoding**: ASCII
...
4. Start the API: uvicorn AAI4001_FinalProject_Group4_fastapi:app --reload

How to Run the Streamlit Frontend
1. Open a new terminal
2. Navigate to the backend folder: cd streamlit_frontend
3. pip install -r requirements.txt
4. Start the API: streamlit run AAI4001_FinalProject_Group4_deployment.py
